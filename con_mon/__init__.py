"""
con_mon package - Resource collector for KOVR.
...
from con_mon.utils.yaml_loader import ConnectorYamlMapping, ResourceYamlMapping
...
def _load_mappings():
    ...
    _create_module('con_mon.mappings')
    ...
    if resources_yaml.exists():
        ...
        for provider_name, mapping in resource_mappings.items():
            ...
            provider_module = _create_module(f'con_mon.mappings.{provider_name}')
