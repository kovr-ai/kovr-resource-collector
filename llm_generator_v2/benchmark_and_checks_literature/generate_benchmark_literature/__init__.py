...
# Auto-detect service and module names from file path
current_path = Path(__file__).parent
service_name = current_path.name  # e.g., "generate_benchmark_literature"
module_name = current_path.parent.name  # e.g., "benchmark_and_checks_literature"
...
for field_name, field_info in Input.model_fields.items():
    ...
    if hasattr(nested_model, '__name__'):  # It's a proper model class
