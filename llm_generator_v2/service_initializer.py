...
def setup(
    ...
    execution_yaml_path = Path(__file__).parents[0] / "execution.yaml"
    ...
    globals_['service'] = service
    
    # Make dynamic Input and Output models available
    Input = service.Input
    globals_['Input'] = Input

    Output = service.Output
    globals_['Output'] = Output
    ...
    for model_name, model_class in nested_models.items():
        globals_[model_name] = model_class
