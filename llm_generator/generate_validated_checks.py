...
from con_mon.compliance.data_loader.checks_loader import ChecksLoader

from llm_generator.benchmark_and_checks_literature import (
    generate_benchmark_literature as gbl,
    extract_check_names as ecn,
    enrich_individual_checks as eic,
)
from llm_generator.system_compatible_checks_literature import (
    add_targeted_literature as atl,
    consolidate_resource_wise_checks as crwc,
)
from llm_generator.checks_with_python_logic import (
...
def insert_in_db():
    ...
    yaml_check_loader = YamlChecksLoader(
        Path("llm_generator/data/debugging_BKP/sec3_checks_with_python_logic/step4_consolidate_repaired_checks/output")
    )
    loaded_yaml_checks = yaml_check_loader.load_all_checks
